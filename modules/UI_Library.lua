...
local Menu = ZenLibrary:CreateMenu({
    Name = "Zen X » Attack on Titan: Evolution",
    ConfigurationSaving = {
       Enabled = true,
       FolderName = "Library Testing",
       FileName = "Config"
    },
})

-- Tabs
local MainTab = Menu:CreateTab('Auto Mission/Auto Raid')

-- Sections
local autoMission = MainTab:CreateSection({Name = "Auto Mission", Side = "Left"})
local autoRaid = MainTab:CreateSection({Name = "Auto Raid", Side = "Right"})

-- autoMission
local aat = autoMission:CreateToggle({Name = "Auto Mission", CurrentValue = false, Flag = "autoMission", Callback = function(v)
    print(v)
end})

autoMission:CreateButton({Name = "Auto Button Unlocked 2", CurrentValue = false, Callback = function(v)
    print(v)
end})

autoMission:CreateLockedButton({Name = " Button l7uc ", CurrentValue = false, Callback = function(v)
    print(v)
end})
local aat = autoMission:CreateToggle({Name = "Auto Mission", CurrentValue = false, Flag = "autoMission", Callback = function(v)
    print(v)
end})
autoMission:CreateLockedButton({Name = " Button  loxl ", CurrentValue = false, Callback = function(v)
    print(v)
end})
autoMission:CreateButton({Name = " Button  ", CurrentValue = false, Callback = function(v)
    print(v)
end})
local aat = autoMission:CreateToggle({Name = "Auto Mission", CurrentValue = false, Flag = "autoMission", Callback = function(v)
    print(v)
...
if LGPremium then
    ...
    autoMission:CreateButton({Name = "Auto Button Unlocked", CurrentValue = false, Callback = function(v)
        print(v)
    end})
end 
